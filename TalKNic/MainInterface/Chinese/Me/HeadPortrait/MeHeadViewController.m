...
@interface MeHeadViewController ()
...
@implementation MeHeadViewController
...
-(void)initView
{
    self.showImgView = [[UIImageView alloc]initWithFrame:kCGRectMake(0, 0, 320, 480)];
...
- (void)cancel:(id)sender {
    if (self.delegate && [self.delegate conformsToProtocol:@protocol(MeImageCropperDelegate)]) {
