                             ...
                             duration:(NSInteger)duration
{
    ...
    NSString *shenfen = [user objectForKey:kChooese_ChineseOrForeigner];
    ...
    if (payDate) {
        ...
        else
        {
            ...
            [session POST:@"http://115.47.28.121/Talknic1.0/admin.php/api/index?cmd=17" parameters:parmes progress:^(NSProgress * _Nonnull uploadProgress) {
