...
- (void)viewDidLoad {
    ...
    self.navigationItem.titleView = [ViewControllerUtil SetTitle:@"Information (1/2)"];
...
-(void)nextAction
{
    ...
    [session GET:PATH_GET_LOGIN parameters:dic progress:^(NSProgress * _Nonnull uploadProgress) {
        ...
        {
            Foreigner2ViewController *foreVC = [[Foreigner2ViewController alloc]init];
            foreVC.usID = _uID;
